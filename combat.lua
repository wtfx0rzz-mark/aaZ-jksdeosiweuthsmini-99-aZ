return function(C, R, UI)
    ...
    local DEFAULT_RADIUS = tonumber(TUNE.DEFAULT_AURA_RADIUS) or 100
    C.State.AuraRadius = tonumber(C.State.AuraRadius) or DEFAULT_RADIUS
    ...
    CombatTab:Slider({
        Title = "Distance",
        Value = { Min = 0, Max = 500, Default = C.State.AuraRadius },
        Callback = function(v)
