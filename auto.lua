return function(C, R, UI)
    local function run()
        ...
        local function groundRay(pos, excludes)
        ...
        local showPhaseEdge=false, showPlantEdge=false, showTeleportEdge=false, showCampEdge=true
        ...
        local function teleportNearChest(m)
            ...
            local groundP = groundBelow(desired)
