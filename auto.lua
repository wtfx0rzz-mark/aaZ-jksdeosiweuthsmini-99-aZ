    ...
    -- Chest Finder toggle (directly below Auto Collect Coins)
    ...
    tab:Toggle({
        ...
        Value = false,
        Callback = function(state)
            if state then if enableChestFinder then enableChestFinder() end
            else if disableChestFinder then disableChestFinder() end end
        end
    })
    ...
    -- Chest Finder implementation (logic and button)
    do
